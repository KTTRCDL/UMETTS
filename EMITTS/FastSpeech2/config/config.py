...
class TrainConfig:
    ...
    raw_data_path: Path = "path/to/ssw_esd"
    val_ids_path: Path = "path/to/val_ids.txt"
    test_ids_path: Path = "path/to/test_ids.txt"
    preprocessed_data_path: Path = "path/to/preprocessed"
    ...
    # Vocoder
    vocoder_checkpoint_path: str = "path/to/vocoder/checkpoint"
    ...
    phones_mapping_path: Path = "path/to/phones.json"
    ...
    lightning_checkpoint_path: str = "path/to/checkpoint" # directory to save checkpoints
    train_from_checkpoint: Optional[str] = None # filename in <lightning_checkpoint_path> directory
    num_workers: int = 35
    test_wav_files_directory: str = "path/to/data/wav"
    test_mos_files_directory: str = "path/to/data/mos"
    ...
    testing_checkpoint: str = "path/to/checkpoint" 
    audio_save_path: str = "path/to/data/deepvk_test" # directory where synthesised wav files will be saved
